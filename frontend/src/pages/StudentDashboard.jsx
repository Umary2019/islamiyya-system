        ...
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-blue-700">{totalRecords}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-blue-700">{averageGrade}</p>
            </div>
            <div className="text-5xl opacity-20">🎯</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-4xl font-bold text-blue-700">{summaries.length}</p>
            </div>
            <div className="text-5xl opacity-20">📊</div>
          </div>
        </div>
            ...
            {records.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg border-l-4 border-blue-500">
                  ...
                  <p className="text-5xl font-bold text-blue-700">{averageGrade}</p>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-lg border-l-4 border-blue-500">
                  ...
                  <p className="text-5xl font-bold text-blue-700">{failedCount}</p>
